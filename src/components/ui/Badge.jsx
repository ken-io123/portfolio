...
const Badge = ({ 
  ...
  const colorVariants = {
    ...
    violet: 'bg-black text-white shadow-lg shadow-black/40 border border-black/30 dark:bg-white dark:text-black dark:shadow-lg dark:shadow-white/20 dark:border dark:border-violet-200',
